...
function ManageEventCreate(props: any) {
  ...
  useEffect(() => {
    ...
    getManageEventByEventIdAPI &&
      getManageEventByEventIdAPI('1706')
        // getManageEventByEventIdAPI(fileData[0].eventId)
        .then((res: any) => {
          const eventData =
            ManagePageApiData[0].eventDetailsList[0].rangeEventRequest
          console.log('EVENTID', eventData)
          const milestoneData =
            ManagePageApiData[0].eventDetailsList[0].milestones
          ...
          const manageList = [
            {
              ...
              taskIdEvent: 'e19df1a4-c792-11ec-bdca-026cd852799d', //eventData.taskId,
          ...
          eventData.eventHeader.eventTeam.team.map((val: any) => {
            ...
            if (val.persona === 'Range Reset Manager') {
              ...
              manageList[0].rangeResetManagerEmailId.emailId =
                val.details.emailId
            ...
            if (val.persona === 'Senior Buying Manager') {
              ...
              manageList[0].seniorBuyingManagerEmailId.userId =
                val.details.userId
            }
            ...
            if (val.persona === 'Category Director') {
              ...
              manageList[0].categoryDirectorEmailId.emailId =
                val.details.emailId
            ...
            if (val.persona === 'Supply Chain Specialist') {
              ...
              manageList[0].supplyChainAnalystEmailId.userId =
                val.details.userId
            }
          })
          ...
          const manageTask = milestoneData.map((milestone: any) => {
            return {
              ...
              status: 'ACTIVE', //milestone.status,
  ...
  const handlePublishEvent = (clickState: any) => {
    ...
    const publishEvent = {
      ...
      requester: {
        persona: eventDetails[0].requesterName,
        details: {
      ...
      eventHeader: {
        ...
        inventoryControl: {
          planogramClass: eventDetails[0].planogramClass,
    ...
    claimEventsCamunda(eventDetails[0].taskIdEvent, claimTaskData)
      .then((res: any) => {
        ...
        publishEvent &&
          putManageEventByEventIdAPI &&
          putManageEventByEventIdAPI(publishEvent, eventDetails[0].eventId)
            .then((res: any) => {
