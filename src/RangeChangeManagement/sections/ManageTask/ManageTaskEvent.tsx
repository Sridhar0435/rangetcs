...
import { setFile, resetFile } from '../../../redux/Actions/FileUpload'
...
function ManageTaskEvent(props: any) {
  const { userDetail, setFile, resetFile } = props
  ...
  const handleSingleEvent = (data: any) => {
    ...
    let singleRow = [data]
    setFile(singleRow)
    history.push(`${DEFAULT}${RANGEAMEND_MANAGE_TASK}/${data.eventId}`)
  }
